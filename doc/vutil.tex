...
The type ``\subcmdlink[0]{new}{list}'' validates that the input is a list, and additionally passes input from its main ``\texttt{:=}'' operator through the \cmdlink{lexpr} command.
\begin{syntax}
