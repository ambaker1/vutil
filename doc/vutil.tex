...
The main concept of the object variable is that if called as a command with no arguments, it will return the object variable value. 
All object variable methods that modify the object variable return the object name, allowing for nested object variable modification calls.
...
\clearpage
\subsection{Object Variable Access}
...
Calling the object variable directly (e.g. \texttt{[\$varObj]}) returns the value stored in the object variable. 
\begin{syntax}
\$varObj
\end{syntax}
