...
The method ``\methodlink[0]{var}{=}'' assigns the value of the object variable.
\begin{syntax}
\method{var}{=} \$value
\end{syntax}
\begin{args}
...
\end{args}
The method ``\methodlink[0]{var}{<-}'' assigns the value of the object directly from another object variable of the same class.
\begin{syntax}
...
\end{args}
The method ``\methodlink[0]{var}{-{}->}'' copies the object variable.
\begin{syntax}
...
The command \cmdlink{new} creates a new variable object of specified type.
